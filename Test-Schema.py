...
def initialize_excel_schema(file_path):
    ...
    schemas = {
        ...
        # WIDENED TABLE: Manager assignments and Pitching stats added
        "Player_Ratings": [
            "player_id", "season", "team_id", "league_level", "age", "position", "role", 
            ...
            "stam_max", "stam_cur", "pit_velo", "pit_vel_armspd", "pit_vel_decept", 
            "pit_ctrl", "pit_ctrl_acc", "pit_ctrl_cmd", "pit_mov", "pit_mov_spin", "pit_mov_bite"
        ],
        ...
        # NEW TABLE: Tracks accolades per season and league
        "Awards": ["award_id", "player_id", "season", "competition", "title"]
    }
